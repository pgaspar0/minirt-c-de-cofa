...
/*   Updated: 2025/03/22 23:24:49 by gamekiller2      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_color add_dlight(t_minirt *rt, t_color color, t_point bateu, t_point normal)
{
    ...
    if (esc < 0)
        return(color);
    dif_color.r = (color.r * rt->light.color.r / 255.0) * rt->light.ratio * esc;
    dif_color.g = (color.g * rt->light.color.g / 255.0) * rt->light.ratio * esc;
    dif_color.b = (color.b * rt->light.color.b / 255.0) * rt->light.ratio * esc;
