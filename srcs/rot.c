...
/*   Updated: 2025/05/24 12:46:32 by pgaspar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (rt->mini.type == 1)
        rt->plane[rt->mini.index].n_vector = rotate_x(rt->plane[rt->mini.index].n_vector, val);
    else if (rt->mini.type == 2)
        rt->cylinder[rt->mini.index].a_vector = rotate_x(rt->cylinder[rt->mini.index].a_vector, val);
...
{
    if (rt->mini.type == 1)
        rt->plane[rt->mini.index].n_vector = rotate_y(rt->plane[rt->mini.index].n_vector, val);
    else if (rt->mini.type == 2)
        rt->cylinder[rt->mini.index].a_vector = rotate_y(rt->cylinder[rt->mini.index].a_vector, val);
    else if (rt->mini.type == 3)
...
{
    if (rt->mini.type == 1)
        rt->plane[rt->mini.index].n_vector = rotate_z(rt->plane[rt->mini.index].n_vector, val);
    else if (rt->mini.type == 2)
        rt->cylinder[rt->mini.index].a_vector = rotate_z(rt->cylinder[rt->mini.index].a_vector, val);
    else if (rt->mini.type == 3)
