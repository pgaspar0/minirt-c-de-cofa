...
SRCS = ./srcs/rot.c ./srcs/cylinder_aux.c ./srcs/trans.c ./srcs/shorteners.c ./srcs/hooksmain.c ./srcs/hooks1.c ./srcs/hooks2.c ./srcs/hooks3.c ./srcs/interloops.c ./srcs/lightapp.c ./srcs/intersections.c ./srcs/hfuncs.c ./srcs/tracing.c ./srcs/minirt.c ./srcs/camera.c ./srcs/parse.c ./srcs/vexmanip.c ./srcs/verifications.c ./srcs/verifications2.c
OBJS = ${SRCS:.c=.o}
BLUE = \033[1;36m
RED = \033[1;31m
RESET = \033[0m
